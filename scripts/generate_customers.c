 ...
 * ID range extended to ensure uniqueness (original range 100000~999999 allows
 * only 900,000 unique values).
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#define ID_START 100000
#define ID_END   1099999 /* Extended range to ensure uniqueness */
...
int main(void) {
    ...
    /* Prepare and shuffle unique IDs */
